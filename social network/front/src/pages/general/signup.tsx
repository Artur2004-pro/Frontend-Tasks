...
import type { IResponse, NewUser } from "../../types.ts";
      ...
      >
        ...
        >
          ...
          <motion.div className="flex flex-col gap-1" variants={itemVariants}>
            ...
            <label className="text-gray-300 font-medium">Surname</label>
            <input
        ...
        {/* Bottom link */}
        <motion.p className="text-gray-400 text-sm text-center mt-6" variants={itemVariants}>
